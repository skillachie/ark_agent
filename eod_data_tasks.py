...
def get_eod_data(symbol):
    ...
    #TODO retry task after 15 minutes
...
def generate_eod_tasks():
    ...
    #TODO check if historical data for stocks were already loaded
    #if not load it using date to current date

    #TODO If already loaded then just load todays data using current date
